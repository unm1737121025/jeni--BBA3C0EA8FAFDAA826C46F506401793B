...
method called play() which prints "The player is playing cricket.Derive two classess, Batsman and
Bowler, from the player class. override the play() method in each derived class to print "THe batsmn
